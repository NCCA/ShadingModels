...
subroutine void shading( in vec3 _normal, inout vec4 _ambient, inout vec4 _diffuse, inout vec4 _specular);

subroutine uniform shading shadingModelSelection;
...
shadingModelSelection(fragmentNormal,ambient,diffuse,specular);
